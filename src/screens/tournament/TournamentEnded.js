...
import { apiGetTournamentOpenFinished } from '../../api/RestAPI';
...
function TournamentEnded() {
  ...
  const getTournamentList = async () => {
    try {
      ...
      const { data } = await apiGetTournamentOpenFinished(params);
