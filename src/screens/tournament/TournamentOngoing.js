...
function TournamentOngoing({ route }) {
  ...
  const getTournamentList = async () => {
    try {
      ...
      const { data } = await apiGetTournamentOpenApply(params);
