...
import {
  ...
  apiPostAcademyConfigMngRecruits,
} from '../../api/RestAPI';
...
function AcademyRecruitmentRegist({ route }) {
  ...
  const init = () => {
    setSelectedGenderType(genderList[0].value);
    setSelectedPeriodType(recruitmentPeriodList[0].value);
  };
...
export default memo(AcademyRecruitmentRegist);
