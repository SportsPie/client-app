...
export const eventParticipantPartListSlice = createSlice({
  name: 'eventParticipantPartList',
  initialState,
  reducers: {
...
export const eventParticipantPartListAction =
  eventParticipantPartListSlice.actions;

export default eventParticipantPartListSlice.reducer;
