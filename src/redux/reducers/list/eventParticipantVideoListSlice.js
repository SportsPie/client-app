...
export const eventParticipantVideoListSlice = createSlice({
  name: 'eventParticipantVideoList',
  initialState,
  reducers: {
...
export const eventParticipantVideoListAction =
  eventParticipantVideoListSlice.actions;

export default eventParticipantVideoListSlice.reducer;
