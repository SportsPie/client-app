...
export const matchingScheduleListSlice = createSlice({
  name: 'matchingScheduleList',
  initialState,
  reducers: {
...
export const matchingScheduleListAction = matchingScheduleListSlice.actions;

export default matchingScheduleListSlice.reducer;
