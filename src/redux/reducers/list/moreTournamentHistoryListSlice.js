...
export const moreTournamentHistoryListSlice = createSlice({
  name: 'moreTournamentHistoryList',
  initialState,
  reducers: {
...
export const moreTournamentHistoryListAction =
  moreTournamentHistoryListSlice.actions;

export default moreTournamentHistoryListSlice.reducer;
