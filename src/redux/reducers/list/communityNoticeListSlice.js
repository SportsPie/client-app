...
export const communityNoticeListSlice = createSlice({
...
export const communityNoticeListAction = communityNoticeListSlice.actions;

export default communityNoticeListSlice.reducer;
