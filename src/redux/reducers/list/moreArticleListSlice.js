...
export const moreArticleListSlice = createSlice({
  name: 'moreArticleList',
  initialState,
  reducers: {
...
export const moreArticleListAction = moreArticleListSlice.actions;

export default moreArticleListSlice.reducer;
