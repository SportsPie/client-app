...
export const searchAcademyListSlice = createSlice({
  name: 'searchAcademyList',
  initialState,
  reducers: {
...
export const searchAcademyListAction = searchAcademyListSlice.actions;

export default searchAcademyListSlice.reducer;
