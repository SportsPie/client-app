...
export const moreGameScheduleListSlice = createSlice({
  name: 'moreGameScheduleList',
  initialState,
  reducers: {
...
export const moreGameScheduleListAction = moreGameScheduleListSlice.actions;

export default moreGameScheduleListSlice.reducer;
