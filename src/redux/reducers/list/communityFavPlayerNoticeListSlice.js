...
export const communityFavPlayerNoticeListSlice = createSlice({
  name: 'communityFavPlayerNoticeList',
  initialState,
  reducers: {
...
export const communityFavPlayerNoticeListAction =
  communityFavPlayerNoticeListSlice.actions;

export default communityFavPlayerNoticeListSlice.reducer;
