...
export const moreArticleBookmarksListSlice = createSlice({
  name: 'moreArticleBookmarksList',
  initialState,
  reducers: {
...
export const moreArticleBookmarksListAction =
  moreArticleBookmarksListSlice.actions;

export default moreArticleBookmarksListSlice.reducer;
