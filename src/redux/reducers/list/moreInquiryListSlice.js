...
export const moreInquiryListSlice = createSlice({
  name: 'moreInquiryList',
  initialState,
  reducers: {
...
export const moreInquiryListAction = moreInquiryListSlice.actions;

export default moreInquiryListSlice.reducer;
