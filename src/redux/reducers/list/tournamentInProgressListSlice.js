...
export const tournamentInProgressListSlice = createSlice({
  name: 'tournamentInProgressList',
  initialState,
  reducers: {
...
export const tournamentInProgressListAction =
  tournamentInProgressListSlice.actions;

export default tournamentInProgressListSlice.reducer;
