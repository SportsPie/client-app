...
export const walletHistoryListSlice = createSlice({
...
export const walletHistoryListAction = walletHistoryListSlice.actions;

export default walletHistoryListSlice.reducer;
