...
export const tournamentOngoingListSlice = createSlice({
  name: 'tournamentOngoingList',
  initialState,
  reducers: {
...
export const tournamentOngoingListAction = tournamentOngoingListSlice.actions;

export default tournamentOngoingListSlice.reducer;
