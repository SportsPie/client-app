...
export const academyScheduleListSlice = createSlice({
  name: 'academyScheduleList',
  initialState,
  reducers: {
...
export const academyScheduleListAction = academyScheduleListSlice.actions;

export default academyScheduleListSlice.reducer;
