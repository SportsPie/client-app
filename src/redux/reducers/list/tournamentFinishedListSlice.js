...
export const tournamentFinishedListSlice = createSlice({
  name: 'tournamentFinishedList',
  initialState,
  reducers: {
...
export const tournamentFinishedListAction = tournamentFinishedListSlice.actions;

export default tournamentFinishedListSlice.reducer;
