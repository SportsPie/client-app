...
export const academyCommunityCommentListSlice = createSlice({
  name: 'academyCommunityCommentList',
  initialState,
  reducers: {
...
export const academyCommunityCommentListAction =
  academyCommunityCommentListSlice.actions;

export default academyCommunityCommentListSlice.reducer;
