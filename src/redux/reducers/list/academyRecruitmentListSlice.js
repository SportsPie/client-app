...
export const academyRecruitmentListSlice = createSlice({
  name: 'academyRecruitmentList',
  initialState,
  reducers: {
...
export const academyRecruitmentListAction = academyRecruitmentListSlice.actions;

export default academyRecruitmentListSlice.reducer;
