...
export const socialTokenHistoryListSlice = createSlice({
  name: 'socialTokenHistoryList',
  initialState,
  reducers: {
...
export const socialTokenHistoryListAction = socialTokenHistoryListSlice.actions;

export default socialTokenHistoryListSlice.reducer;
