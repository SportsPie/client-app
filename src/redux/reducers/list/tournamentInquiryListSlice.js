...
export const tournamentInquiryListSlice = createSlice({
  name: 'tournamentInquiryList',
  initialState,
  reducers: {
...
export const tournamentInquiryListAction = tournamentInquiryListSlice.actions;

export default tournamentInquiryListSlice.reducer;
