...
export const eventParticipantCommentListSlice = createSlice({
  name: 'eventParticipantCommentList',
  initialState,
  reducers: {
...
export const eventParticipantCommentListAction =
  eventParticipantCommentListSlice.actions;

export default eventParticipantCommentListSlice.reducer;
