...
export const matchingHistoryListSlice = createSlice({
  name: 'matchingHistoryList',
  initialState,
  reducers: {
...
export const matchingHistoryListAction = matchingHistoryListSlice.actions;

export default matchingHistoryListSlice.reducer;
