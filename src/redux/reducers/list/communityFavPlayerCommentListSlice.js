...
export const communityFavPlayerCommentListSlice = createSlice({
  name: 'communityFavPlayerCommentList',
  initialState,
  reducers: {
...
export const communityFavPlayerCommentListAction =
  communityFavPlayerCommentListSlice.actions;

export default communityFavPlayerCommentListSlice.reducer;
