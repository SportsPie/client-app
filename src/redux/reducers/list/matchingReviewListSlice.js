...
export const matchingReviewListSlice = createSlice({
  name: 'matchingReviewList',
  initialState,
  reducers: {
...
export const matchingReviewListAction = matchingReviewListSlice.actions;

export default matchingReviewListSlice.reducer;
