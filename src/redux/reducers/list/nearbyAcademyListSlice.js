...
export const nearbyAcademyListSlice = createSlice({
  name: 'nearbyAcademyList',
  initialState,
  reducers: {
...
export const nearbyAcademyListAction = nearbyAcademyListSlice.actions;

export default nearbyAcademyListSlice.reducer;
