...
export const chatSlice = createSlice({
  ...
  reducers: {
    ...
    setNewMessageTimeIdTemp: (state, action) => {
      state.newMessageTimeIdTemp = action.payload;
    },
